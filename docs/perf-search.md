...
> *(2026-08-25 승인·반영됨 — [01-erd.md](00_overview/01-erd.md) 인덱스 절. 이후 인덱스 변경은 백엔드 오너 판단 + ERD 같은 커밋 갱신 + 사후 공지. 2026-09-02 부터 팀장 없음.)*
...
## ~~팀장 합의 후~~ `models.py` 에 반영할 제안 (2026-08-25 반영 완료)
